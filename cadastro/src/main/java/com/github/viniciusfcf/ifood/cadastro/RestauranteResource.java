...
public class RestauranteResource {
	...
	@Counted(name = "Quantidade buscas Restaurante") // Contar quantas vezes foi chamado
	@SimplyTimed(name = "Tempo simples de busca") // Tempo de demora a média de execuções
	@Timed(name = "Tempo completo de busca") // Disponibiliza agrupamentos dependendo do tempo
	//@Gauge() Pegar informação expecifica Ex: Quantidade de memória, temperatura do processador, etc
	public List<RestauranteDTO> buscar() {
		Restaurante.findById(123L);
